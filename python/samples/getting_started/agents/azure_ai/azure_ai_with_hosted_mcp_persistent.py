...
load_dotenv()
"""
Azure AI Agent with Hosted MCP Example (Persistent Version)
...
async def main() -> None:
    """Example showing Hosted MCP tools for a Azure AI Agent with persistent agent creation."""
