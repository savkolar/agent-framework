...
uses OpenAPI tools to answer user questions (Persistent Version).
...
async def main() -> None:
    ...
    # 2. Use AIProjectClient to create persistent agents
    async with (
        ...
        try:
            ...
            async with ChatAgent(
                ...
                print("=== Azure AI Agent with OpenAPI Tools (Persistent) ===\n")
